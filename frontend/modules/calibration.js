(function initCameraCalibration(ns) {
  ...
  function setDeviceCalibrationState(deviceProfile) {
    state.deviceProfile = deviceProfile || null;
    state.deviceHasCameraCalibration = Boolean(deviceProfile?.camera_calibration);
    ns.setCameraUI(Boolean(state.stream));
  }
